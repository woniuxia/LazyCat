...
export async function diagnosisCancel(runId: string): Promise<AccessPathDiagnosisCancelResponse> {
...
const CHANNEL_MAP: Record<string, { domain: string; action: string }> = {
  ...
  "tool:request-forward:auto-start-update": {
    domain: "request_forward",
    action: "auto_start_update",
  },
  "tool:request-forward:status": { domain: "request_forward", action: "status" },
  "tool:request-forward:log-capture-update": {
    domain: "request_forward",
    action: "log_capture_update",
  },
  ...
  "tool:api-mock:project-list": { domain: "api_mock", action: "project_list" },
  "tool:api-mock:project-create": { domain: "api_mock", action: "project_create" },
  "tool:api-mock:project-update": { domain: "api_mock", action: "project_update" },
  ...
  "tool:release-package:project-delete-scope": {
    domain: "release_package",
    action: "project_delete_scope",
  },
  ...
  "tool:release-package:command-retry-prepare": {
    domain: "release_package",
    action: "command_retry_prepare",
  },
  "tool:release-package:command-retry-preflight": {
    domain: "release_package",
    action: "command_retry_preflight",
  },
  "tool:release-package:command-retry-start": {
    domain: "release_package",
    action: "command_retry_start",
  },
  ...
  "tool:action-center:combination-target-list": {
    domain: "action_center",
    action: "combination_target_list",
  },
  ...
  "tool:api-mock:route-toggle": { domain: "api_mock", action: "route_toggle" },
  "tool:api-mock:route-delete": { domain: "api_mock", action: "route_delete" },
  "tool:api-mock:route-reorder": { domain: "api_mock", action: "route_reorder" },
  "tool:api-mock:file-import": { domain: "api_mock", action: "file_import" },
  "tool:api-mock:service-start": { domain: "api_mock", action: "service_start" },
  "tool:api-mock:service-stop": { domain: "api_mock", action: "service_stop" },
  "tool:api-mock:service-status": { domain: "api_mock", action: "service_status" },
  "tool:api-mock:request-logs": { domain: "api_mock", action: "request_logs" },
  "tool:api-mock:request-logs-clear": { domain: "api_mock", action: "request_logs_clear" },
  ...
  "tool:pomodoro:get-state": { domain: "pomodoro", action: "get_state" },
  "tool:pomodoro:set-enabled": { domain: "pomodoro", action: "set_enabled" },
  "tool:pomodoro:start-today": { domain: "pomodoro", action: "start_today" },
  "tool:pomodoro:skip-today": { domain: "pomodoro", action: "skip_today" },
  "tool:pomodoro:stop-today": { domain: "pomodoro", action: "stop_today" },
  "tool:jwt:decode": { domain: "jwt", action: "decode" },
  "tool:data-dictionary:list": { domain: "data_dictionary", action: "list" },
  "tool:data-dictionary:get": { domain: "data_dictionary", action: "get" },
  "tool:data-dictionary:import-preview": { domain: "data_dictionary", action: "import_preview" },
  "tool:data-dictionary:create": { domain: "data_dictionary", action: "create" },
  "tool:data-dictionary:rename": { domain: "data_dictionary", action: "rename" },
  "tool:data-dictionary:replace-records": { domain: "data_dictionary", action: "replace_records" },
  ...
  "tool:data-dictionary:mark-record-used": {
    domain: "data_dictionary",
    action: "mark_record_used",
  },
  ...
  "tool:launcher:spotlight-list": { domain: "launcher", action: "spotlight_list" },
  ...
  "tool:browser-profiles:set-chrome-path": {
    domain: "browser_profiles",
    action: "set_chrome_path",
  },
  ...
  "tool:todo:spotlight-list": { domain: "todo", action: "spotlight_list" },
  "tool:todo:item-record-open": { domain: "todo", action: "item_record_open" },
  ...
  "tool:follow-up:item-list": { domain: "follow_up", action: "item_list" },
  "tool:follow-up:item-get": { domain: "follow_up", action: "item_get" },
  "tool:follow-up:item-create": { domain: "follow_up", action: "item_create" },
  "tool:follow-up:item-update": { domain: "follow_up", action: "item_update" },
  "tool:follow-up:progress-add": { domain: "follow_up", action: "progress_add" },
  "tool:follow-up:continue": { domain: "follow_up", action: "continue_following" },
  "tool:follow-up:confirm-completed": { domain: "follow_up", action: "confirm_completed" },
  "tool:follow-up:confirm-canceled": { domain: "follow_up", action: "confirm_canceled" },
  "tool:follow-up:stop": { domain: "follow_up", action: "stop_following" },
  "tool:follow-up:reopen": { domain: "follow_up", action: "reopen" },
  "tool:follow-up:progress-update": { domain: "follow_up", action: "progress_update" },
  "tool:follow-up:progress-delete": { domain: "follow_up", action: "progress_delete" },
  "tool:follow-up:item-snooze": { domain: "follow_up", action: "item_snooze" },
  "tool:follow-up:item-delete": { domain: "follow_up", action: "item_delete" },
  "tool:usage:tool-summaries": { domain: "usage", action: "tool_summaries" },
  "tool:usage:summaries": { domain: "usage", action: "summaries" },
  "tool:usage:record-tool-open": { domain: "usage", action: "record_tool_open" },
  ...
  "tool:pm:spotlight-list": { domain: "pm", action: "spotlight_list" },
  "tool:pm:item-record-open": { domain: "pm", action: "item_record_open" },
  ...
  "tool:pm:item-todo-candidates-by-project": {
    domain: "pm",
    action: "item_todo_candidates_by_project",
  },
...
export async function invokeToolByChannel<TResponse = unknown>(
  ...
  try {
    ...
    if (
      ...
      throw new Error(
        "IPC bridge 未加载，请在 Tauri 环境运行。请使用 `pnpm dev` 或 `pnpm --filter @lazycat/desktop dev` 启动。",
        { cause: error },
      );
    }
