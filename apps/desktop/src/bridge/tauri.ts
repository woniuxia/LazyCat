...
const CHANNEL_MAP: Record<string, { domain: string; action: string }> = {
  ...
  "tool:db:connection-list": { domain: "db", action: "connection_list" },
  "tool:db:connection-save": { domain: "db", action: "connection_save" },
  "tool:db:connection-delete": { domain: "db", action: "connection_delete" },
  "tool:db:connection-test": { domain: "db", action: "connection_test" },
  "tool:db:connection-open": { domain: "db", action: "connection_open" },
  "tool:db:connection-close": { domain: "db", action: "connection_close" },
  "tool:db:schema-databases": { domain: "db", action: "schema_databases" },
  "tool:db:schema-tables": { domain: "db", action: "schema_tables" },
  "tool:db:schema-table-detail": { domain: "db", action: "schema_table_detail" },
  "tool:db:query-execute": { domain: "db", action: "query_execute" },
  "tool:db:query-cancel": { domain: "db", action: "query_cancel" },
  "tool:db:table-data-page": { domain: "db", action: "table_data_page" },
  "tool:db:table-apply-changes": { domain: "db", action: "table_apply_changes" },
  "tool:db:result-export": { domain: "db", action: "result_export" },
  "tool:db:saved-query-list": { domain: "db", action: "saved_query_list" },
  "tool:db:saved-query-save": { domain: "db", action: "saved_query_save" },
  "tool:db:saved-query-delete": { domain: "db", action: "saved_query_delete" },
  "tool:db:history-list": { domain: "db", action: "history_list" },
  "tool:db:history-clear": { domain: "db", action: "history_clear" },
  "tool:db:redis-scan": { domain: "db", action: "redis_scan" },
  "tool:db:redis-key-detail": { domain: "db", action: "redis_key_detail" },
  "tool:db:redis-key-write": { domain: "db", action: "redis_key_write" },
  "tool:db:redis-command": { domain: "db", action: "redis_command" },
