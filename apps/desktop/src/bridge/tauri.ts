...
const CHANNEL_MAP: Record<string, { domain: string; action: string }> = {
  ...
  "tool:api-workbench:export-curl": { domain: "api_workbench", action: "export_curl" },
  "tool:api-workbench:history-save-request": { domain: "api_workbench", action: "history_save_request" },
  "tool:api-workbench:request-save-example-response": { domain: "api_workbench", action: "request_save_example_response" },
  ...
  "tool:api-workbench:response-preview-office": { domain: "api_workbench", action: "response_preview_office" },
  "tool:api-workbench:response-cache-open": { domain: "api_workbench", action: "response_cache_open" },
  "tool:api-workbench:response-cache-reveal": { domain: "api_workbench", action: "response_cache_reveal" },
