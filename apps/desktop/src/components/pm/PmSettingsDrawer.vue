<template>
  ...
  >
    <template #header> 导入与设置 </template>
            ...
            <div class="import-section">
              ...
              <div class="import-mapping-row">
                ...
                <el-button size="small" :disabled="!canSaveTemplate" @click="saveTemplate"
                  >保存模板</el-button
                >
                <el-button size="small" :disabled="!templateId" @click="deleteTemplate"
                  >删除</el-button
                >
              </div>
          ...
          <div v-if="result" class="import-section import-result">
            <el-alert type="success" :closable="false">
              <template #title>
                ...
                <span v-if="result.projectsCreated"
                  >，新建项目 {{ result.projectsCreated }} 个</span
                >
                <span v-if="result.skippedDuplicate">
                  | 编号重复跳过 {{ result.skippedDuplicate }}</span
                >
                ...
                >
                <span v-if="result.skippedNoProject">
                  | 无项目跳过 {{ result.skippedNoProject }}</span
                >
              </template>
            </el-alert>
          </div>
        ...
        <div class="pm-settings-body">
          ...
          <div class="pm-siyuan-config-card">
            ...
            <div class="pm-siyuan-inline-actions">
              <el-button size="small" @click="siyuan.openLocationPicker('global')"
                >选择位置</el-button
              >
        ...
        <template v-else>
          <div class="pm-siyuan-picker-tree-head">
            ...
            <div class="pm-siyuan-inline-actions">
              ...
              >
              <span v-if="siyuan.locationPickerSearchKeyword.value"
                >清空搜索后会恢复默认折叠。</span
              >
              <el-button
                size="small"
